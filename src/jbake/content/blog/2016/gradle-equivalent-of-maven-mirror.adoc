...
Maven has a way to configure mirrors in `settings.xml`. Gradle doesn't have a direct analogue to it, but what it has is really nice. Also it's _underdocumented_.
